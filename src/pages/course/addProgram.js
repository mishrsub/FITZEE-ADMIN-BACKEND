...
import AddProgramForm from 'src/components/courses/AddProgramForm';
import { AddProgramTable } from 'src/sections/course/add-program-table';
const now = new Date();
          ...
          <Stack spacing={3}>
            ...
            >
              ...
              <div>
               ...
               <Modals Form={AddProgramForm} title={"Add Program"} open={open} handleClose={handleClose} />    
              </div>
            </Stack>
            <AddProgramTable
